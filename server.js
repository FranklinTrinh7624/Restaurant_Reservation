...
const store = new MongoDBSession({
  uri:'mongodb+srv://sakibz:sakibzafar123@beardencluster.cp0uqer.mongodb.net/BearDen?retryWrites=true&w=majority',
...
mongoose.connect("mongodb+srv://sakibz:sakibzafar123@beardencluster.cp0uqer.mongodb.net/BearDen?retryWrites=true&w=majority", {useNewUrlParser: true})
  .then(() => {
    app.listen(5000, () => {
